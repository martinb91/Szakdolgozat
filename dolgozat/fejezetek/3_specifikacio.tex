...
A fejezet összefoglalja, hogy melyek azok a funkciók, amelyekre szüksége lehet a felhasználóknak, így azt az alkalmazásban célszerűnek tünt megvalósítani.
...
\begin{comment}{A kereséshez kapcsolódó dolgokat majd érdemes egy helyre gyűjteni, mert most még az elején és végén van a fejezetnek.}
\end{comment}
...
\section{Fesztiválok adatainak kezelése}
